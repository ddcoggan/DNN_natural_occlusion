...
def get_activations(model=None, architecture=None, image_dir=None, inputs=None,
    ...
    for layer, acts in activations.items():
        ...
        # normal case, feedforward DNN, multiple batches
        ...
        # recurrent DNN where different cycles are in different list items
        ...
        # recurrent DNN where different cycles are mixed in each list item
